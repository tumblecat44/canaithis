...
- **솔루션** — 챌린지에 대한 답. 설명 + GitHub 링크 + 데모 URL을 같이 올린다. 단순 프롬프트 자랑이 아니라, 다른 사람이 따라할 수 있는 정도의 재료가 들어가도록 폼을 유도한다.
...
erDiagram
    ...
    Solution  { String id PK  String content String githubUrl String demoUrl String challengeId FK String authorId FK DateTime createdAt }
