...
### [2026-06-10] #177 — 틱 20260610T024637Z: invalid locale nested challenges page category automation sort latest 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-category-automation-sort-latest-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&category=automation&sort=latest` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&category=automation&sort=latest` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-nested-challenges-page-category-automation-sort-popular-404` — `/xx/challenges?page=2&category=automation&sort=popular` 404.

### [2026-06-10] #178 — 틱 20260610T025247Z: invalid locale nested challenges page category automation sort popular 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-category-automation-sort-popular-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&category=automation&sort=popular` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&category=automation&sort=popular` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-nested-challenges-page-category-automation-sort-views-404` — `/xx/challenges?page=2&category=automation&sort=views` 404.

### [2026-06-10] #179 — 틱 20260610T025841Z: invalid locale nested challenges page category automation sort views 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-category-automation-sort-views-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&category=automation&sort=views` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&category=automation&sort=views` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-home-page-q-search-category-automation-404` — `/xx?page=2&q=test&category=automation` 404.

### [2026-06-10] #180 — 틱 20260610T030432Z: invalid locale home page search category automation 404 smoke

- **이 턴**: `smoke-invalid-locale-home-page-q-search-category-automation-404` — `autopilot.sh`·`smoke.yml`에 `/xx?page=2&q=test&category=automation` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx?page=2&q=test&category=automation` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-404` — `/xx/challenges?page=2&q=test&category=automation` 404.

### [2026-06-10] #181 — 틱 20260610T031027Z: invalid locale nested challenges page search category automation 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&q=test&category=automation` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&q=test&category=automation` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-sort-latest-404` — `/xx/challenges?page=2&q=test&category=automation&sort=latest` 404.

### [2026-06-10] #182 — 틱 20260610T031629Z: invalid locale nested challenges page search category automation sort latest 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-sort-latest-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&q=test&category=automation&sort=latest` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&q=test&category=automation&sort=latest` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-sort-popular-404` — `/xx/challenges?page=2&q=test&category=automation&sort=popular` 404.

### [2026-06-10] #183 — 틱 20260610T032232Z: invalid locale nested challenges page search category automation sort popular 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-sort-popular-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&q=test&category=automation&sort=popular` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&q=test&category=automation&sort=popular` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-sort-views-404` — `/xx/challenges?page=2&q=test&category=automation&sort=views` 404.

### [2026-06-10] #184 — 틱 20260610T032832Z: invalid locale nested challenges page search category automation sort views 404 smoke

- **이 턴**: `smoke-invalid-locale-nested-challenges-page-q-search-category-automation-sort-views-404` — `autopilot.sh`·`smoke.yml`에 `/xx/challenges?page=2&q=test&category=automation&sort=views` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx/challenges?page=2&q=test&category=automation&sort=views` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-home-page-q-search-category-automation-sort-latest-404` — `/xx?page=2&q=test&category=automation&sort=latest` 404.

### [2026-06-10] #185 — 틱 20260610T033457Z: invalid locale home page search category automation sort latest 404 smoke

- **이 턴**: `smoke-invalid-locale-home-page-q-search-category-automation-sort-latest-404` — `autopilot.sh`·`smoke.yml`에 `/xx?page=2&q=test&category=automation&sort=latest` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx?page=2&q=test&category=automation&sort=latest` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-home-page-q-search-category-automation-sort-popular-404` — `/xx?page=2&q=test&category=automation&sort=popular` 404.

### [2026-06-10] #186 — 틱 20260610T110704Z: invalid locale home page search category automation sort popular 404 smoke

- **이 턴**: `smoke-invalid-locale-home-page-q-search-category-automation-sort-popular-404` — `autopilot.sh`·`smoke.yml`에 `/xx?page=2&q=test&category=automation&sort=popular` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx?page=2&q=test&category=automation&sort=popular` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-home-page-q-search-category-automation-sort-views-404` — `/xx?page=2&q=test&category=automation&sort=views` 404.

### [2026-06-10] #187 — 틱 20260610T111505Z: invalid locale home page search category automation sort views 404 smoke

- **이 턴**: `smoke-invalid-locale-home-page-q-search-category-automation-sort-views-404` — `autopilot.sh`·`smoke.yml`에 `/xx?page=2&q=test&category=automation&sort=views` 404 검증 추가.
- **curl 검증**: 프로덕션 `/xx?page=2&q=test&category=automation&sort=views` → 404 확인 후 push.
- **다음 pending**: `smoke-invalid-locale-home-category-other-404` — `/xx?category=other` 404.
